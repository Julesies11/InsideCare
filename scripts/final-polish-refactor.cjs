...
walkDir('src', (filePath) => {
  ...
  content = content.replace(/completed_at\s+ic_house_checklist_submission_items/g, "completed_at, ic_house_checklist_submission_items");
  content = content.replace(/\.eq\("ic_house_calendar_event_staff\.staff_id', staffId\)/g, ".eq('ic_house_calendar_event_staff.staff_id', staffId)");
