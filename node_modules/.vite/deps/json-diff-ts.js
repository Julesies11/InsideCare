...
var applyChangeset = (obj, changeset) => {
  if (changeset) {
    changeset.forEach((change) => {
      ...
      if (value !== null && value !== void 0 || type === "REMOVE" || value === null && type === "ADD") {
...
var revertChangeset = (obj, changeset) => {
  if (changeset) {
    changeset.reverse().forEach((change) => {
      ...
      if (!change.changes || value === null && type === "REMOVE") {
...
var applyArrayChange = (arr, change) => {
  ...
  for (const subchange of changes) {
    if (subchange.value !== null && subchange.value !== void 0 || subchange.type === "REMOVE" || subchange.value === null && subchange.type === "ADD") {
...
var revertArrayChange = (arr, change) => {
  for (const subchange of change.changes) {
    if (subchange.value != null || subchange.type === "REMOVE") {
...
//# sourceMappingURL=json-diff-ts.js.map
