...
import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-DFSQFJEB.js";
import {
  dist_exports,
  useDirection
} from "./chunk-RQIEBDZI.js";
import {
  Label as Label2,
  dist_exports as dist_exports5
} from "./chunk-XQKV2FZ5.js";
import {
  composeRefs,
  createSlot,
  createSlottable,
  ...
  useComposedRefs
} from "./chunk-ORIBEIYP.js";
import {
  require_react_dom
} from "./chunk-WWQOA3DT.js";
import {
  require_jsx_runtime
} from "./chunk-PA5WIMTD.js";
import {
  require_react
} from "./chunk-7ODZWU7A.js";
import "./chunk-YAZPUYLT.js";
import {
  __export,
  __toESM
...
var AccessibleIcon = ({ children, label }) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    ...
    (0, import_jsx_runtime3.jsx)(Root5, { children: label })
  ] });
};
...
var AlertDialog = (props) => {
  ...
  return (0, import_jsx_runtime8.jsx)(Root4, { ...dialogScope, ...alertDialogProps, modal: true });
};
...
var AlertDialogPortal = (props) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime8.jsx)(Portal3, { ...dialogScope, ...portalProps });
};
...
var Avatar = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    const [imageLoadingStatus, setImageLoadingStatus] = React12.useState("idle");
    return (0, import_jsx_runtime12.jsx)(
      AvatarProvider,
      {
        ...
        children: (0, import_jsx_runtime12.jsx)(Primitive5.span, { ...avatarProps, ref: forwardedRef })
      }
    );
  }
);
...
var AvatarImage = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    return imageLoadingStatus === "loaded" ? (0, import_jsx_runtime12.jsx)(Primitive5.img, { ...imageProps, ref: forwardedRef, src }) : null;
  }
);
AvatarImage.displayName = IMAGE_NAME;
var FALLBACK_NAME = "AvatarFallback";
var AvatarFallback = React12.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, delayMs, ...fallbackProps } = props;
    const context = useAvatarContext(FALLBACK_NAME, __scopeAvatar);
    const [canRender, setCanRender] = React12.useState(delayMs === void 0);
    React12.useEffect(() => {
      if (delayMs !== void 0) {
    ...
    return canRender && context.imageLoadingStatus !== "loaded" ? (0, import_jsx_runtime12.jsx)(Primitive5.span, { ...fallbackProps, ref: forwardedRef }) : null;
  }
);
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin }) {
  ...
  const imageRef = React12.useRef(null);
  const image = (() => {
  ...
  const [loadingStatus, setLoadingStatus] = React12.useState(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime14.jsx)(
      CheckboxProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
...
var ContextMenuTrigger = React17.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME5, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React17.useRef({ x: 0, y: 0 });
    const virtualRef = React17.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React17.useRef(0);
    ...
    React17.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuContent = React17.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React17.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React17.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React17.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuCheckboxItem = React17.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioGroup = React17.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioItem = React17.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React17.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React17.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React17.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuSubTrigger = React17.forwardRef((props, forwardedRef) => {
...
var ContextMenuSubContent = React17.forwardRef((props, forwardedRef) => {
...
var FormMessageImpl = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(Primitive8.span, { id, ...messageProps, ref: forwardedRef });
  }
);
...
var FormSubmit = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(Primitive8.button, { type: "submit", ...submitProps, ref: forwardedRef });
  }
);
...
var HoverCard = (props) => {
  ...
  const closeTimerRef = React21.useRef(0);
  const hasSelectionRef = React21.useRef(false);
  const isPointerDownOnContentRef = React21.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleDismiss = React21.useCallback(() => setOpen(false), [setOpen]);
  React21.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
  ...
  return (0, import_jsx_runtime20.jsx)(
    HoverCardProvider,
    {
      ...
      children: (0, import_jsx_runtime20.jsx)(Root2, { ...popperScope, children })
    }
  );
};
HoverCard.displayName = HOVERCARD_NAME;
var TRIGGER_NAME6 = "HoverCardTrigger";
var HoverCardTrigger = React21.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardPortal = (props) => {
  ...
  return (0, import_jsx_runtime20.jsx)(PortalProvider, { scope: __scopeHoverCard, forceMount, children: (0, import_jsx_runtime20.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime20.jsx)(Portal, { asChild: true, container, children }) }) });
};
HoverCardPortal.displayName = PORTAL_NAME3;
var CONTENT_NAME5 = "HoverCardContent";
var HoverCardContent = React21.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContentImpl = React21.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React21.useState(false);
  React21.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React21.forwardRef(
  (props, forwardedRef) => {
...
var Menubar = React23.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React23.useState(null);
    return (0, import_jsx_runtime22.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React23.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React23.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React23.useCallback(
          (value2) => {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime22.jsx)(Collection2.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime22.jsx)(Collection2.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime22.jsx)(
          Root3,
          {
            asChild: true,
            ...
            children: (0, import_jsx_runtime22.jsx)(Primitive10.div, { role: "menubar", ...menubarProps, ref: forwardedRef })
          }
        ) }) })
      }
    );
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React23.useRef(false);
...
var MenubarTrigger = React23.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime22.jsx)(Collection2.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime22.jsx)(
      Item,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        children: (0, import_jsx_runtime22.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime22.jsx)(
          Primitive10.button,
          {
            type: "button",
            role: "menuitem",
...
var MenubarPortal = (props) => {
  ...
  const menuScope = useMenuScope2(__scopeMenubar);
  return (0, import_jsx_runtime22.jsx)(Portal2, { ...menuScope, ...portalProps });
};
...
var MenubarGroup = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React23.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React23.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...arrowProps } = props;
    const menuScope = useMenuScope2(__scopeMenubar);
    return (0, import_jsx_runtime22.jsx)(Arrow2, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var MenubarSubTrigger = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React23.forwardRef(
  (props, forwardedRef) => {
...
var Primitive11 = NODES11.reduce((primitive, node) => {
  ...
  const Node = React24.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(
      NavigationMenuProvider,
      {
        ...
        onItemDismiss: () => setValue(""),
        children: (0, import_jsx_runtime24.jsx)(Primitive11.div, { "data-orientation": orientation, ...subProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuProvider = (props) => {
  ...
  return (0, import_jsx_runtime24.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      children: (0, import_jsx_runtime24.jsx)(Collection3.Provider, { scope, children: (0, import_jsx_runtime24.jsx)(ViewportContentProvider, { scope, items: viewportContent, children }) })
    }
  );
};
...
var NavigationMenuList = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    const list = (0, import_jsx_runtime24.jsx)(Primitive11.ul, { "data-orientation": context.orientation, ...listProps, ref: forwardedRef });
    return (0, import_jsx_runtime24.jsx)(Primitive11.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: (0, import_jsx_runtime24.jsx)(Collection3.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? (0, import_jsx_runtime24.jsx)(FocusGroup, { asChild: true, children: list }) : list }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(
      NavigationMenuItemContextProvider,
      {
        ...
        children: (0, import_jsx_runtime24.jsx)(Primitive11.li, { ...itemProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuTrigger = React25.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [
    (0, import_jsx_runtime24.jsx)(Collection3.ItemSlot, { scope: __scopeNavigationMenu, value: itemContext.value, children: (0, import_jsx_runtime24.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime24.jsx)(
      Primitive11.button,
      {
        id: triggerId,
        disabled,
...
var NavigationMenuViewportImpl = React25.forwardRef((props, forwardedRef) => {
  ...
  const [size, setSize] = React25.useState(null);
...
var FocusGroup = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(FocusGroupCollection.Provider, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime24.jsx)(FocusGroupCollection.Slot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime24.jsx)(Primitive11.div, { dir: context.dir, ...groupProps, ref: forwardedRef }) }) });
  }
);
...
var Primitive12 = NODES12.reduce((primitive, node) => {
  ...
  const Node = React26.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
var Root10 = Primitive12;
...
var OneTimePasswordField = React27.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React27.useCallback(
      (value2) => {
    ...
    const controlledValue = React27.useMemo(() => {
    ...
    const validationTypeRef = React27.useRef(validation);
    React27.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React27.useRef(null);
    const userActionRef = React27.useRef(null);
    ...
    const locateForm = React27.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React27.useCallback(() => {
    ...
    const valueRef = React27.useRef(currentValue);
    ...
    return (0, import_jsx_runtime26.jsx)(
      OneTimePasswordFieldContext,
      {
        ...
        isHydrated,
        sanitizeValue,
        children: (0, import_jsx_runtime26.jsx)(Collection4.Provider, { scope: __scopeOneTimePasswordField, state: collectionState, children: (0, import_jsx_runtime26.jsx)(Collection4.Slot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime26.jsx)(
          Root3,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var OneTimePasswordFieldHiddenInput = React27.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React27.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React27.useState(null);
  ...
  const keyboardActionTimeoutRef = React27.useRef(null);
  React27.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime26.jsx)(Collection4.ItemSlot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime26.jsx)(
    Item,
    {
      ...rovingFocusGroupScope,
      asChild: true,
...
var PasswordToggleFieldIcon = React29.forwardRef(
  ({
    ...
    return (0, import_jsx_runtime28.jsx)(Primitive13.svg, { ...domProps, ref: forwardedRef, "aria-hidden": true, asChild: true, children: visible ? visibleIcon : hiddenIcon });
  }
);
...
var Primitive14 = NODES14.reduce((primitive, node) => {
  ...
  const Node = React30.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React31.useState(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  return (0, import_jsx_runtime30.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime30.jsx)(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React31.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React31.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React31.forwardRef(
  (props, forwardedRef) => {
...
var PopoverTrigger = React31.forwardRef(
  (props, forwardedRef) => {
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime30.jsx)(PortalProvider2, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime30.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime30.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContentModal = React31.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME8, props.__scopePopover);
    const contentRef = React31.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React31.useRef(false);
    React31.useEffect(() => {
      const content = contentRef.current;
      if (content) return hideOthers(content);
    }, []);
    return (0, import_jsx_runtime30.jsx)(Combination_default, { as: Slot, allowPinchZoom: true, children: (0, import_jsx_runtime30.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverContentNonModal = React31.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME8, props.__scopePopover);
...
var PopoverContentImpl = React31.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React31.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React31.forwardRef(
  (props, forwardedRef) => {
    const { __scopePopover, ...arrowProps } = props;
    const popperScope = usePopperScope2(__scopePopover);
    return (0, import_jsx_runtime30.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Primitive15 = NODES15.reduce((primitive, node) => {
  ...
  const Node = React32.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime31.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var Progress = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime32.jsx)(ProgressProvider, { scope: __scopeProgress, value, max, children: (0, import_jsx_runtime32.jsx)(
      Primitive15.div,
      {
        "aria-valuemax": max,
        "aria-valuemin": 0,
...
var ProgressIndicator = React33.forwardRef(
  (props, forwardedRef) => {
...
var Primitive16 = NODES16.reduce((primitive, node) => {
  ...
  const Node = React34.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime33.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var Primitive17 = NODES17.reduce((primitive, node) => {
  const Slot3 = createSlot(`Primitive.${node}`);
  const Node = React36.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot3 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime36.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
    ...
    return (0, import_jsx_runtime37.jsxs)(import_jsx_runtime37.Fragment, { children: [
      ...
      (0, import_jsx_runtime37.jsx)(
        Primitive17.div,
        {
          ...
          children: (0, import_jsx_runtime37.jsx)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" }, children })
        }
      )
    ] });
  }
...
var ScrollAreaScrollbar = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.type === "hover" ? (0, import_jsx_runtime37.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? (0, import_jsx_runtime37.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? (0, import_jsx_runtime37.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? (0, import_jsx_runtime37.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaScrollbarHover = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime37.jsx)(Presence, { present: forceMount || visible, children: (0, import_jsx_runtime37.jsx)(
...
var ScrollAreaScrollbarScroll = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime37.jsx)(Presence, { present: forceMount || state !== "hidden", children: (0, import_jsx_runtime37.jsx)(
...
var ScrollAreaThumb = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime37.jsx)(Presence, { present: forceMount || scrollbarContext.hasThumb, children: (0, import_jsx_runtime37.jsx)(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
...
var ScrollAreaCorner = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return hasCorner ? (0, import_jsx_runtime37.jsx)(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaCornerImpl = React211.forwardRef((props, forwardedRef) => {
  ...
  return hasSize ? (0, import_jsx_runtime37.jsx)(
    Primitive17.div,
    {
      ...cornerProps,
      ref: forwardedRef,
...
var Primitive18 = NODES18.reduce((primitive, node) => {
  const Slot3 = createSlot(`Primitive.${node}`);
  const Node = React38.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot3 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime38.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime39.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime39.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime39.jsx)(Collection5.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime39.jsx)(
        ...
        isFormControl2 ? (0, import_jsx_runtime39.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
            ...
            form,
            children: [
              value === void 0 ? (0, import_jsx_runtime39.jsx)("option", { value: "" }) : null,
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime39.jsx)(
      Primitive18.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? (0, import_jsx_runtime39.jsx)(import_jsx_runtime39.Fragment, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime39.jsx)(Primitive18.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME6 = "SelectPortal";
var SelectPortal = (props) => {
  return (0, import_jsx_runtime39.jsx)(Portal, { asChild: true, ...props });
};
...
var SelectContent = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      const frag = fragment;
      return frag ? ReactDOM20.createPortal(
        (0, import_jsx_runtime39.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime39.jsx)(Collection5.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime39.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return (0, import_jsx_runtime39.jsx)(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime39.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime39.jsx)(Combination_default, { as: Slot2, allowPinchZoom: true, children: (0, import_jsx_runtime39.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [
      ...
      (0, import_jsx_runtime39.jsx)(Collection5.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime39.jsx)(
        Primitive18.div,
        {
...
var SelectGroup = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime39.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime39.jsx)(Primitive18.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime39.jsx)(Primitive18.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    const nativeOption = React39.useMemo(
      () => (0, import_jsx_runtime39.jsx)("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value),
    ...
    return (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [
      (0, import_jsx_runtime39.jsx)(Primitive18.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
      itemContext.isSelected && context.valueNode && !context.valueNodeHasChildren ? ReactDOM20.createPortal(itemTextProps.children, context.valueNode) : null
    ] });
  }
);
...
var SelectItemIndicator = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime39.jsx)(Primitive18.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectScrollUpButton = React39.forwardRef((props, forwardedRef) => {
  ...
  return canScrollUp ? (0, import_jsx_runtime39.jsx)(
...
var SelectScrollDownButton = React39.forwardRef((props, forwardedRef) => {
  ...
  return canScrollDown ? (0, import_jsx_runtime39.jsx)(
    SelectScrollButtonImpl,
    {
      ...props,
      ref: composedRefs,
...
var SelectSeparator = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime39.jsx)(Primitive18.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
...
var SelectArrow = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime39.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
...
var Primitive19 = NODES19.reduce((primitive, node) => {
  const Slot3 = createSlot(`Primitive.${node}`);
  const Node = React40.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot3 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime40.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var Separator4 = React41.forwardRef((props, forwardedRef) => {
...
var Primitive20 = NODES20.reduce((primitive, node) => {
  const Slot3 = createSlot(`Primitive.${node}`);
  const Node = React42.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot3 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime42.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime43.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime43.jsx)(Collection6.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime43.jsx)(Collection6.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime43.jsx)(
          SliderOrientation,
          {
...
var SliderThumb = React43.forwardRef(
  (props, forwardedRef) => {
    ...
    const index = React43.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime43.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index });
  }
);
var SliderThumbImpl = React43.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime43.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime43.jsx)(Collection6.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime43.jsx)(
            Primitive20.span,
            {
              role: "slider",
          ...
          isFormControl2 && (0, import_jsx_runtime43.jsx)(
            SliderBubbleInput,
            {
...
var Primitive22 = NODES22.reduce((primitive, node) => {
  const Slot3 = createSlot(`Primitive.${node}`);
  const Node = React46.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot3 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime46.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var TabsList = React47.forwardRef(
  (props, forwardedRef) => {
...
var TabsTrigger = React47.forwardRef(
  (props, forwardedRef) => {
...
var TabsContent = React47.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React47.useRef(isSelected);
    React47.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
    return (0, import_jsx_runtime47.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime47.jsx)(
      Primitive22.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
...
function dispatchDiscreteCustomEvent2(target, event) {
  if (target) ReactDOM25.flushSync(() => target.dispatchEvent(event));
}
...
var ToastProvider = (props) => {
  ...
  return (0, import_jsx_runtime49.jsx)(Collection7.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime49.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime49.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime49.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime49.jsx)(Collection7.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime49.jsx)(Primitive23.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime49.jsx)(
            FocusProxy,
            {
...
var Toast = React49.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime49.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime49.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React49.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime49.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime49.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM26.createPortal(
        (0, import_jsx_runtime49.jsx)(Collection7.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime49.jsx)(
          Root,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime49.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime49.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React49.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime49.jsx)(Primitive23.div, { ...titleProps, ref: forwardedRef });
  }
);
...
var ToastDescription = React49.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime49.jsx)(Primitive23.div, { ...descriptionProps, ref: forwardedRef });
  }
);
...
var ToastAction = React49.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime49.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime49.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
...
var ToastClose = React49.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime49.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime49.jsx)(
      Primitive23.button,
      {
        type: "button",
        ...closeProps,
...
var Primitive24 = NODES24.reduce((primitive, node) => {
  ...
  const Node = React50.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime50.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var NAME5 = "Toggle";
var Toggle = React51.forwardRef((props, forwardedRef) => {
...
var ReactDOM28 = __toESM(require_react_dom(), 1);
...
var Primitive25 = NODES25.reduce((primitive, node) => {
  const Slot3 = createSlot(`Primitive.${node}`);
  const Node = React52.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot3 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime52.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var ToggleGroup = import_react2.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime53.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime53.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react2.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime53.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime53.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react2.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime53.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime53.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react2.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime53.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime53.jsx)(
      Root3,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime53.jsx)(Primitive25.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime53.jsx)(Primitive25.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react2.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime53.jsx)(
      Item,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime53.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime53.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
var ReactDOM29 = __toESM(require_react_dom(), 1);
...
var Primitive26 = NODES26.reduce((primitive, node) => {
  const Slot3 = createSlot(`Primitive.${node}`);
  const Node = React54.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot3 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime54.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var Toolbar = React55.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, orientation = "horizontal", dir, loop = true, ...toolbarProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    const direction = useDirection(dir);
    return (0, import_jsx_runtime55.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime55.jsx)(
      Root3,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarSeparator = React55.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React55.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    return (0, import_jsx_runtime55.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime55.jsx)(Primitive26.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React55.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    return (0, import_jsx_runtime55.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime55.jsx)(
      Primitive26.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React55.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React55.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime55.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime55.jsx)(Item24, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
var ReactDOM30 = __toESM(require_react_dom(), 1);
...
var Primitive27 = NODES27.reduce((primitive, node) => {
  const Slot3 = createSlot(`Primitive.${node}`);
  const Node = React56.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot3 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime56.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React57.useRef(true);
...
var Tooltip = (props) => {
  ...
  return (0, import_jsx_runtime57.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime57.jsx)(
...
var TooltipTrigger = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime57.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime57.jsx)(
      Primitive27.button,
      {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime57.jsx)(PortalProvider3, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime57.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime57.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var TooltipContent = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime57.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime57.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime57.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React57.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime57.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime57.jsxs)(
          Content,
          {
            ...
            children: [
              (0, import_jsx_runtime57.jsx)(Slottable2, { children }),
              (0, import_jsx_runtime57.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime57.jsx)(Root5, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime57.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
export {
  ...
  dist_exports5 as Label,
  dist_exports20 as Menubar,
