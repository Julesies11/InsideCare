-- Migration: Fix SECURITY DEFINER for auth.users sync functions
BEGIN;

-- Explicitly ensure triggers/functions are SECURITY DEFINER
CREATE OR REPLACE FUNCTION public.ic_sync_staff_role_to_metadata() 
RETURNS trigger AS $$
BEGIN
...
-- Also verify the main sync function is SECURITY DEFINER
