-- Migration: Add Incident and Shift Note Reference ID to Audit Log Enhanced Name Resolution
-- Created: 2026-06-09
-- Sequential: 01
-- Description: Updates ic_audit_trigger_func() to extract 'reference_id' for Incident Reports and Shift Notes,
-- preventing null fallback entity names from defaulting to raw UUIDs in the Activity Log view.
-- Sets stored entity_type for ic_incident_reports to 'incidents'.
