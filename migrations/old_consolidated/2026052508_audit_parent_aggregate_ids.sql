-- Migration: Audit Parent Aggregate Root IDs
-- Date: 2026-05-25
-- Description: Ensures child record actions are logged against the Parent's ID so they appear in contextual logs.
