-- Migration: Improve Activity Log Descriptions (Verified Gold Standard)
-- Created: 2026-06-03
-- Auditor: Senior Software Engineer & Security Researcher
-- Description: Enriches audit descriptions with specific entity names (e.g. Compliance Name, Contact Name) 
-- instead of generic fallbacks. Adds relational lookups for Medications and Leave Types.
