      ...
      <div className="flex flex-col gap-5 lg:gap-7.5">
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-muted-foreground">
              Manage the master list of leave types available for staff
              requests.
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              These types are currently visible to staff in the leave request
              form.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
              ...
              <div className="py-10 text-center text-muted-foreground">
                No active leave types found. Click "Manage Master List" to add
                some.
              </div>
            ) : (
              <Table>
