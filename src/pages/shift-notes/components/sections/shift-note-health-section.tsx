        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <Label htmlFor="regular_medication_status">Regular medication administered?</Label>
              <Select
                value={formData.regular_medication_status || 'none'}
                onValueChange={(val) => onFormChange('regular_medication_status', val === 'none' ? null : val)}
                disabled={!canEdit}
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="No IR submitted">No IR submitted</SelectItem>
                  <SelectItem value="Not applicable to shift">Not applicable to shift</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="space-y-3">
              ...
              {formData.prn_medication_given && (
                <div className="space-y-1.5 animate-in fade-in slide-in-from-top-1">
                  <Label htmlFor="prn_description" className="text-xs text-muted-foreground">
                    Describe why PRN medication was given, what was observed beforehand, and the effect after administration.
                  </Label>
                  <Textarea
                    id="prn_description"
                    value={formData.prn_description || ''}
                    onChange={(e) => onFormChange('prn_description', e.target.value)}
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
            ...
            {formData.pbs_strategies_used && (
              <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
                <div className="space-y-2">
                  <Label htmlFor="pbs_strategies_details">What Strategies were used?</Label>
                  <p className="text-xs text-muted-foreground">
                    Describe the strategies used (e.g. redirection, prompting, offering choices, environmental changes).
                  </p>
                  <Textarea
                    id="pbs_strategies_details"
                    value={formData.pbs_strategies_details || ''}
                    onChange={(e) => onFormChange('pbs_strategies_details', e.target.value)}
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    (e.g. proactively before behaviour, during escalation, after incident)
                  </p>
                  <Input
                    id="pbs_when_used"
                    value={formData.pbs_when_used || ''}
                    onChange={(e) => onFormChange('pbs_when_used', e.target.value)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => onFormChange('pbs_outcome', e.target.value)}
          ...
          <div className="pt-4 border-t border-dashed">
            <div className="flex items-center justify-between">
              <Label htmlFor="restrictive_practices_status">Restrictive Practices</Label>
              <Select
                value={formData.restrictive_practices_status || 'none'}
                onValueChange={(val) => onFormChange('restrictive_practices_status', val === 'none' ? null : val)}
                disabled={!canEdit}
              >
                ...
                <SelectContent>
                  <SelectItem value="none">Select status...</SelectItem>
                  <SelectItem value="Yes Incident Report Submitted">Yes Incident Report Submitted</SelectItem>
                  <SelectItem value="No">No</SelectItem>
                  <SelectItem value="Not applicable to client">Not applicable to client</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
