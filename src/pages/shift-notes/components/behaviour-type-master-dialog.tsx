...
import { useBehaviourTypesMaster, useAddBehaviourTypeMaster, useUpdateBehaviourTypeMaster, BehaviourTypeMaster } from '@/hooks/use-behaviour-types-master';
            ...
            <div className="divide-y divide-border">
              {isLoading ? (
                ...
                <div className="p-8 text-center text-muted-foreground text-sm">
                  {searchQuery ? 'No matching types found.' : 'No behaviour types added yet.'}
                </div>
              ) : (
