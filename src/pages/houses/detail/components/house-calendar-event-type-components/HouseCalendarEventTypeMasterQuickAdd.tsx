    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            {eventType
              ? 'Update the details for this calendar event type.'
              : 'Create a new calendar event type for the master list.'}
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, event_type_name: e.target.value })
                }
          ...
          <DialogFooter>
            ...
            <Button type="submit">{eventType ? 'Update' : 'Add'}</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
