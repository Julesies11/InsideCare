      ...
      <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden border-none shadow-2xl">
        ...
        <div
          className={cn(
            ...
            themeClasses.split(' ')[0].replace('/10', ''),
          )}
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-2">
              ...
              >
                {isEvent
                  ? shift.type_name || 'Meeting'
                  : shift.shift_template || 'Shift'}
              </Badge>
            </div>
            ...
            <DialogDescription className="sr-only">
              {isEvent
                ? `Meeting details for ${shift.title}`
              ...
              <div className="space-y-2">
                {shift.participants && shift.participants.length > 0 ? (
                  shift.participants.map((p) => (
                    <div
                      key={p.id}
                      className="flex items-center gap-2.5 p-2.5 rounded-lg border bg-card hover:bg-accent/50 transition-colors"
                    >
