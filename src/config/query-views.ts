...
export const SHIFT_NOTE_VIEWS = {
  ...
  DETAIL: `
    ...
    bowel_bristol_scale,
    bowel_amount_id,
    bowel_amount:ic_bowel_amounts_master!bowel_amount_id(name),
    bowel_assistance_id,
    bowel_assistance:ic_bowel_assistance_master!bowel_assistance_id(name),
    bowel_notes,
    seizure_occurred,
    seizure_time_started,
    seizure_duration_minutes,
    seizure_type_id,
    seizure_type:ic_seizure_types_master!seizure_type_id(name),
    seizure_description,
    ...
    sleep_occurred,
    sleep_type_id,
    sleep_type:ic_sleep_types_master!sleep_type_id(name),
    sleep_start_time,
    sleep_wake_time,
    sleep_quality_id,
    sleep_quality:ic_sleep_quality_master!sleep_quality_id(name),
    sleep_support_required,
    behaviour_observed,
    behaviour_type_id,
    behaviour_type:ic_behaviour_types_master!behaviour_type_id(name),
    behaviour_intensity_id,
    behaviour_intensity:ic_behaviour_intensity_master!behaviour_intensity_id(name),
    behaviour_notes,
    ...
    nutrition_meal_type:ic_nutrition_meal_types_master!nutrition_meal_type_id(name),
    nutrition_intake_id,
    nutrition_intake:ic_nutrition_intake_master!nutrition_intake_id(name),
    ...
    mtm_meal_provided,
    mtm_diet_type_id,
    mtm_diet_type:ic_mtm_diet_types_master!mtm_diet_type_id(name),
    mtm_fluids_id,
    mtm_fluids:ic_mtm_fluids_master!mtm_fluids_id(name),
    mtm_texture_correct,
    mtm_consistency_correct,
    mtm_positioning_appropriate,
    mtm_supervision_required,
    mtm_swallowing_concerns_id,
    mtm_swallowing_concerns:ic_mtm_swallowing_concerns_master!mtm_swallowing_concerns_id(name),
    mtm_meal_intake_id,
    mtm_meal_intake:ic_mtm_meal_intake_master!mtm_meal_intake_id(name),
    mtm_meal_intake_notes,
    mtm_fluid_intake_id,
    mtm_fluid_intake:ic_mtm_fluid_intake_master!mtm_fluid_intake_id(name),
    mtm_fluid_intake_notes,
    mtm_concerns,
    mtm_notes,
    hygiene_support_required,
    hygiene_shower_id,
    hygiene_shower:ic_hygiene_levels_master!hygiene_shower_id(name),
    hygiene_oral_care_id,
    hygiene_oral_care:ic_hygiene_levels_master!hygiene_oral_care_id(name),
    hygiene_toileting_id,
    hygiene_toileting:ic_hygiene_levels_master!hygiene_toileting_id(name),
    hygiene_grooming_id,
    hygiene_grooming:ic_hygiene_levels_master!hygiene_grooming_id(name),
